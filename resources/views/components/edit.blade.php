...
@section('content')
    ...
    <div class="row g-5">
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" method="POST" action="/admin/{{ $book->id }}/update" enctype="multipart/form-data">
          @csrf
          <div class="row g-3">
            <div class="col-8">
            ...
            <div class="col-8">
                ...
                <input type="date" class="form-control" id="publication_date" name="publication_date" value="{{$book->publication_date}}" placeholder="" required>
                <div class="invalid-feedback">
            ...
            <div class="col-8">
                ...
                <select class="form-select" id="category_id" name="category_id" required>
                    <option value="{{ $book->category_id}}">{{$book->category->category}}</option>
            ...
            <img style="margin:20px" src="/{{ $book->cover}}">

            <div class="col-10">
                <strong><label for="details" class="form-label">Details</label></strong>
                <textarea class="form-control"  style="height: 300px" id="details" name="details" placeholder="" required>{{$book->details}}</textarea>
