    ...
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
      <div class="col-md-4 d-flex align-items-center">
        <a href="/" class="mb-3 me-2 mb-md-0 text-body-secondary text-decoration-none lh-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="24" fill="currentColor" class="bi bi-bootstrap-fill" viewBox="0 0 16 16">
        ...
        <span class="mb-3 mb-md-0 text-body-secondary text-center">&copy; 2023 by Qiao Zheng. All rights reserved.</span>
      </div>
